...
from sensor.entity.artifact_entity import ModelEvaluationArtifact, ModelPusherArtifact, ModelTrainerArtifact, ModelTrainerArtifact
...
class TrainPipeline:
    ...
    def start_model_evaluation(self, data_validation_artifact:DataValidationArtifact,
        ...
        try:
            ...
            model_eval_artifact = model_eval.inintiate_model_evaluation()
    ...
    def run_pipeline(self):
        try:
            ...
            if not model_eval_artifact.is_model_accected:
